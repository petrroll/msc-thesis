...
Although I did not end up doing my thesis under his supervision, RNDr.~Milan Straka, Ph.D. deserves recognition for patiently lending me his valuable time while I was trying to figure out my eventual thesis topic.
...
\include{./chapters/01_chap}
\include{./chapters/02_chap}
\include{./chapters/03_chap}
\include{./chapters/04_chap}
\include{./chapters/05_chap}
\include{./chapters/06_epilog}
...
\include{text/chapters/abbreviations}

\include{text/chapters/glossary}

\include{text/chapters/attachments}
