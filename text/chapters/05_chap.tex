...
\begin{figure}[H]
    ...
    \caption[Various architectures on region 1]{Various architectures fully trained on {region 1}\protect\footnotemark.}
    \label{fig:5.3.2.1_1}
\end{figure}
\footnotetext{We only have fully trained data for the \citeauthor{antolik} \textit{HSM model}. We thus show the final mean performance and its variance for all time points.}
...
\begin{figure}[H]
    ...
    \caption[Various architectures on region 2]{Various architectures trained on {region 2}\protect\footnotemark.}
    \label{fig:5.3.2.1_2}
\end{figure}
...
\begin{figure}[H]
    ...
    \label{fig:5.3.2.1_3}
\end{figure}
\footnotetext{We only have fully trained data for the \citeauthor{antolik} \textit{HSM model}. We thus show the final mean performance and its variance for all time points\protect\footnotemark[60].}
