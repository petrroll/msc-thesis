...
\begin{figure}[H]
    ...
    \label{fig:5.1.2.1}
\end{figure}
\footnotetext{Unlike the previous figure, this is restricted to 5 000 epochs and 10 runs per experiment instance (refer to \refsection{ch:4.4}).}
...
\textit{Experiment 1.3.1} explored dropout\footnote{Refer to \refsection{ch:1.3.2}.} regularization on the hidden fully connected layer. Since dropout can decrease the effective capacity of the model, we tested three sizes of the hidden layer, the original - 20 \% of the number of output neurons, 30 \% and 40 \%. 
